...
export default function BhopalCompetitorSEOShowcase() {
  ...
  const popularSearches = [
    ...
    { label: "🍎 Buy Fresh Fruits Online Bhopal", query: "fruit" },
    { label: "🍅 Fresh Desi Tamatar (Tomato)", query: "tamatar" },
    { label: "🥔 Pahadi Premium Aloo (Potato)", query: "aloo" },
    { label: "🧅 Nashik Red Onion (Pyaaz)", query: "pyaaz" },
    { label: "🌿 Organic Spinach (Palak)", query: "palak" },
    { label: "🥑 Buy Hass Avocado in Bhopal", query: "avocado" },
    { label: "🥦 Fresh Green Broccoli", query: "broccoli" },
    { label: "🍄 Fresh Button Mushrooms (200g)", query: "mushroom" },
    { label: "🥬 Hydroponic Romaine & Iceberg Lettuce", query: "lettuce" },
    { label: "🧺 Daily Value Combo Vegetable Pack", query: "combo" },
    { label: "🥗 Green Detox & Salad Kit", query: "salad" },
    { label: "🫑 Red & Yellow Bell Peppers", query: "capsicum" },
    { label: "🥒 English Fresh Cucumber", query: "cucumber" },
    { label: "🐉 Fresh Dragon Fruit & Berries", query: "fruit" },
    { label: "⚡ 10-15 Min Express Sabzi Delivery", query: "vegetable" },
    { label: "💵 Cash On Delivery Sabzi in Bhopal", query: "vegetable" },
    { label: "🌿 100% Handpicked & Triple-Checked", query: "fresh" },
    { label: "🚜 Direct Kisan Farm Fresh Produce", query: "farm" },
    { label: "🎉 Zero Platform Fee Fresh Store", query: "fresh" },
  ];
