            ...
            >
              ...
              <form onSubmit={handleSubmitReview} className="space-y-4">
                ...
                <div>
                  ...
                  <input type="text" value={reviewForm.location} onChange={e => setReviewForm({...reviewForm, location: e.target.value})} className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-[#0f8646] focus:border-transparent outline-none" placeholder="Mumbai, India" />
                </div>
                <div>
