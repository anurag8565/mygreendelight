  ...
  const socialChannels = [
    {
      ...
      icon: <FaInstagram className="w-4.5 h-4.5 text-white" />,
    },
    {
      name: "WhatsApp",
    ...
    },
    {
      ...
      icon: <FaFacebookF className="w-4.5 h-4.5 text-white" />,
    },
    {
      name: "Helpline",
      handle: "9981418565",
      ...
      icon: <FaPhone size={15} className="text-white" />,
    },
    {
      name: "Email Desk",
      ...
      icon: <FaEnvelope size={15} className="text-white" />,
    },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-8 lg:gap-10 items-start">
          ...
          <div className="md:col-span-5 lg:col-span-4 flex flex-col w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-2.5 max-w-md mb-4.5 w-full">
              ...
              <div className="bg-white/5 hover:bg-white/[0.08] border border-white/10 rounded-2xl p-3 flex items-center gap-3 transition">
                <div className="w-8.5 h-8.5 rounded-xl bg-amber-500/20 text-amber-300 flex items-center justify-center shrink-0 shadow-inner">
                  <Clock size={15} />
                </div>
                <div className="min-w-0">
            ...
            <div className="grid grid-cols-2 gap-2.5 max-w-md mb-5 w-full">
              <a
                ...
                className="bg-[#25D366] hover:bg-[#20ba59] active:scale-95 text-white py-2.5 px-3 rounded-xl font-bold text-xs transition flex items-center justify-center gap-1.5 shadow-md shadow-emerald-950/40 cursor-pointer text-center group"
              >
              ...
              <a
                href="tel:9981418565"
                className="bg-white/10 hover:bg-white/15 active:scale-95 border border-white/15 text-white py-2.5 px-3 rounded-xl font-bold text-xs transition flex items-center justify-center gap-1.5 shadow-md shadow-emerald-950/40 cursor-pointer text-center group"
              >
            ...
            <div className="pt-1 pb-2 w-full max-w-md">
              <div className="flex items-center justify-between mb-2.5">
                <span className="text-[11px] font-black text-emerald-300 uppercase tracking-wider flex items-center gap-1.5">
                  <RiPlantLine size={13} className="text-emerald-400" />
                  Connect With Us
                </span>
              ...
              <div className="flex items-center gap-2 sm:gap-2.5 flex-wrap">
                {socialChannels.map((item) => (
                  <a
                    ...
                    className={`w-9.5 h-9.5 rounded-xl ${item.bgGradient} flex items-center justify-center text-white shadow-sm hover:scale-110 active:scale-95 transition-all duration-200 cursor-pointer border border-white/15`}
                    title={item.title}
            ...
            <div className="sm:hidden flex flex-col gap-2.5 mt-2">
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden transition">
                <button
                  ...
                  className="w-full py-3 px-4 flex items-center justify-between text-xs font-black text-emerald-300 uppercase tracking-wider cursor-pointer"
                >
        ...
        <div className="border-t border-white/10 mt-8 pt-5 pb-2">
          ...
          <div className="flex flex-wrap gap-1.5 sm:gap-2">
            {localities.map((loc, i) => (
              <span
                key={i}
                className="bg-white/[0.05] hover:bg-emerald-500/20 text-emerald-100/70 hover:text-white px-2.5 py-0.5 rounded-lg text-[10.5px] font-medium transition border border-white/5 cursor-default"
              >
                {loc}
              </span>
            ))}
