              ...
              <div className="flex items-center gap-2 sm:gap-2.5 flex-wrap">
                {socialChannels.map((item) => (
                  <a
                    ...
                    className={`w-9 h-9 sm:w-9.5 sm:h-9.5 rounded-xl ${item.bgGradient} flex items-center justify-center text-white shadow-sm hover:scale-110 active:scale-95 transition-all duration-200 cursor-pointer border border-white/15`}
                    title={item.title}
