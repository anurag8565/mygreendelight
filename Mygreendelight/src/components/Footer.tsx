...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#041a0d] text-white font-sans border-t border-emerald-950/80 pb-24 sm:pb-24 md:pb-24 lg:pb-8 w-full selection:bg-emerald-500 selection:text-white">
