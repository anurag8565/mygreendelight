...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#031d0e] text-white font-sans border-t border-emerald-950/90 pb-36 sm:pb-24 md:pb-12 lg:pb-12 w-full max-w-full overflow-hidden selection:bg-emerald-500 selection:text-white">
