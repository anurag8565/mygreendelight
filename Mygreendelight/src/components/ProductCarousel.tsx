  ...
  return (
    <div className="relative w-full max-w-full">
      ...
      <button
        ...
        className="flex absolute -left-1 sm:-left-3.5 lg:-left-4 top-[70px] sm:top-[75px] -translate-y-1/2 z-20 bg-white/95 backdrop-blur-xs hover:bg-white text-gray-800 hover:text-[#0a3d24] w-7 h-7 sm:w-9 sm:h-9 rounded-full items-center justify-center transition-all shadow-[0_2px_8px_rgba(0,0,0,0.14)] hover:shadow-md border border-gray-200/90 active:scale-90 cursor-pointer"
      >
        <ChevronLeft size={16} className="sm:w-5 sm:h-5 stroke-[2.5]" />
      </button>

      {/* Free-Flowing Smooth Scroll Container (Zero vertical touch lock) */}
      <div
        ref={scrollRef}
        className="flex gap-2.5 sm:gap-4 overflow-x-auto pb-3 pt-1 scrollbar-none -mx-3.5 px-3.5 sm:mx-0 sm:px-0.5 overscroll-x-contain"
