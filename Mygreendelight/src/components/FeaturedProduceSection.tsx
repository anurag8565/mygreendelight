...
export default function FeaturedProduceSection({
  ...
  return (
    <div className="w-full bg-gradient-to-b from-amber-50/40 via-white to-white py-4 sm:py-6 border-y border-amber-100/60">
      <div className="max-w-7xl mx-auto px-3.5 sm:px-6 md:px-8">
        
        {/* Section Header */}
        <div className="flex items-center justify-between mb-3 sm:mb-4">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-2xl bg-amber-400 text-gray-950 flex items-center justify-center font-black shadow-xs">
              <Crown size={17} />
            </div>
            <div>
