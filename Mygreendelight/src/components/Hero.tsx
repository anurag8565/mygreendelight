  ...
  const defaultSlides = [
    {
      ...
      title: "Fresh Vegetables & Fruits Direct from Mandi",
      subtitle: "Daily handpicked harvest, ozone-washed & delivered at lowest prices.",
      ...
      floatingStat: "🌱 5:00 AM Daily Fresh",
    },
    {
      _id: "s2",
      badge: "🍎 100% Naturally Ripe & Sweet",
      title: "Fresh Seasonal Fruits & Orchard Harvest",
      subtitle: "Crisp Apples, Sweet Bananas, Fresh Oranges, Mangoes & Pomegranates.",
      ...
      accentColor: "#f59e0b",
      offerPill: "BEST PRICE GUARANTEE",
      floatingStat: "🍎 100% Quality Checked",
    },
    {
      _id: "s3",
      badge: "🥗 Gourmet Greens & Hydroponic Salads",
      title: "Fresh Hydroponic Salads & Exotic Veggies",
      subtitle: "Lettuce, Cherry Tomatoes, Avocados, Mushrooms & Fresh Herbs.",
      ...
      floatingStat: "🥗 Fresh Daily Stock",
    },
  ];
