  ...
  const defaultSlides = [
    {
      ...
      title: "Farm-Fresh Vegetables & Seasonal Fruits",
      subtitle: "Harvested at 5:00 AM daily from local Kisan farms. 100% hand-graded, triple-checked, and delivered fresh across Bhopal.",
