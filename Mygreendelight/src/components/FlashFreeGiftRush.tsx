  ...
  return (
    <div className="w-full py-1.5 sm:py-2 bg-white">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 md:px-8">
        <div className="bg-gradient-to-r from-[#072817] via-[#0a3d24] to-[#072817] rounded-2xl p-2.5 sm:p-3.5 text-white shadow-sm border border-emerald-900/60 relative overflow-hidden flex items-center justify-between gap-2.5">
          {/* Subtle Ambient Glow */}
          ...
          <div className="shrink-0">
            {!isGiftInCart ? (
              ...
              <Link
                href="/user/cart"
                className="bg-[#0a3d24] hover:bg-[#072817] text-white font-black px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl text-[11px] sm:text-xs shadow-xs active:scale-95 transition-all flex items-center justify-center gap-1 cursor-pointer border border-emerald-400/50"
              >
                <Check size={13} />
                <span>In Cart ➔</span>
              </Link>
