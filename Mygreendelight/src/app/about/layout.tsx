...
export const metadata: Metadata = {
  ...
  description:
    "Learn how SubziQuick connects Bhopal families with direct 5:00 AM Sunrise Farm Harvest, handpicked fresh vegetables, and eco-friendly EV doorstep delivery across Bhopal.",
  keywords: [
    "pesticide free vegetables in bhopal",
    "fresh farm clean vegetables bhopal",
