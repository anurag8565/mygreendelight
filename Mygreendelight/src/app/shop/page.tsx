  ...
  return (
    <div className="bg-[#faf9f5] min-h-screen flex flex-col justify-between font-sans">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-3.5 sm:px-6 md:px-8 py-5 sm:py-8 pb-28 sm:pb-16 w-full">
        ...
        {/* Hyperlocal Bhopal SEO Content & Locality Links */}
        <div className="mt-12 pt-8 border-t border-stone-200/80">
          <div className="bg-white rounded-3xl p-5 sm:p-7 border border-stone-200/80 shadow-2xs">
            <div className="max-w-3xl mb-6">
              <span className="text-[10px] font-black uppercase text-[#0a3d24] bg-emerald-50 px-2.5 py-0.5 rounded-full border border-emerald-200 inline-block mb-1.5">
                Bhopal Localities &amp; Fast Delivery
              </span>
              <h2 className="text-base sm:text-xl font-black text-stone-900 tracking-tight font-heading">
                Fresh Farm Vegetables &amp; Fruits Delivered in 10-15 Minutes in Bhopal
              </h2>
              <p className="text-xs text-stone-500 font-medium mt-1 leading-relaxed">
                Order handpicked chemical-free vegetables, crisp seasonal fruits, exotics, and daily value combos online in Bhopal. Sourced daily at 5:00 AM directly from local Kisan farms with zero platform fee and 100% doorstep quality guarantee.
              </p>
            </div>
            ...
            <div className="mb-5">
              ...
              <div className="flex flex-wrap gap-1.5">
                {[
                  "Arera Colony (E1-E8)", "Kolar Road", "MP Nagar Zone 1 & 2", "Shahpura",
                  "Bawadiya Kalan", "Katara Hills", "Bittan Market E4", "Gulmohar",
                  "Chuna Bhatti", "Trilanga", "Ayodhya Bypass", "Indrapuri BHEL",
                  "Saket Nagar", "TT Nagar", "Hoshangabad Road", "Awadhpuri", "Salaiya", "Misrod"
                ].map((area) => (
                  <span
                    key={area}
                    className="text-[10.5px] font-semibold text-stone-600 bg-stone-50 border border-stone-200/80 px-2.5 py-1 rounded-lg"
                  >
                    📍 {area}
                  </span>
                ))}
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-1.5">
                {[
                  "Desi Tamatar", "Nashik Pyaaz", "Pahadi Aloo", "Organic Palak",
                  "Green Peas Matar", "Hass Avocado", "Green Broccoli", "Button Mushrooms",
                  "Hydroponic Lettuce", "Value Combo Packs", "Dragon Fruit", "Diet Salad Kit"
                ].map((item) => (
                  <button
                    key={item}
                    type="button"
                    ...
                    className="text-[10.5px] font-semibold text-[#0a3d24] bg-emerald-50/60 hover:bg-emerald-100/80 border border-emerald-200/70 px-2.5 py-1 rounded-lg transition-colors cursor-pointer"
                  >
                    🔍 {item}
                  </button>
                ))}
